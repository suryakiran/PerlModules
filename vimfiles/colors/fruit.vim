" Vim color file
"  Maintainer: Tiza
" Last Change: 07-Jul-2010 17:00:00 .
"     version: 1.3
...
" Split area
hi StatusLine   gui=BOLD guifg=#f8f8f8 guibg=#008800
hi StatusLineNC gui=NONE guibg=#a4a4a4 guifg=#404040
hi VertSplit    gui=NONE guifg=#f8f8f8 guibg=#a04040
...
hi NonText      gui=BOLD guifg=#509000 guibg=#ececec
...
hi Typedef	    guifg=#99cc99  gui=ITALIC

hi def link cIncluded NONE
hi def link cueClass NonText

hi cIncluded    gui=ITALIC guifg=#8016ff
hi cppStl       gui=BOLD,ITALIC guifg=#aa00aa
hi cppStlFunctions gui=ITALIC guifg=#cc77cc
hi cppBoolean gui=ITALIC guifg=#8016ff
hi cppStreams gui=BOLD,ITALIC guifg=#00aa00
hi cppCasts   gui=ITALIC guifg=#aa0000
