...
syn match cFunction "str\(cat\|cmp\|chr\|rchr\|str\|sep\|pbrk\|dup\|tok\|casecmp\|coll\|ncmp\|ncpy\|cpy\|ncasecmp\|ncat\|len\|error\)"
syn match cFunction "[fp]\(open\|close\)"
syn match cFunction "\(c\|m\|re\)alloc"
syn match cFunction "\(mk\|rm\)dir"
