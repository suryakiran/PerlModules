...
" <C-S-F8> should create a new scratch buffer. You can do your scribes
" here and if you want to get rid of it, hit <C-S-F8> again inside scratch buffer
" window. If you want to get back to the scratch buffer repeat <C-S-F8>.
"
"
" Custom mappings
" ---------------
...
"----------------------------------------------------------------------
"Standard Inteface:  <C-S-F8> to make a new ScratchBuffer, <C-S-F8>-again to hide one
if !hasmapto('<Plug>ShowScratchBuffer',"n")
  nmap <unique> <silent> <C-S-F8> <Plug>ShowScratchBuffer
endif
if !hasmapto('<Plug>InsShowScratchBuffer',"i")
  imap <unique> <silent> <C-S-F8> <Plug>InsShowScratchBuffer
endif
