...
"              "<" : all separators aligned to left   if of differing lengths
"              ">" : all separators aligned to right  if of differing lengths
"              "|" : all separators aligned to center if of differing lengths
"
