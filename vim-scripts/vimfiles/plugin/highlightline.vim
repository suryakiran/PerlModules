...
map <S-F2> :call <SID>HighlightLine()<CR>
map <S-F3> :call <SID>UnHighlightLine()<CR>
imap <S-F2> <C-O>:call <SID>HighlightLine()<CR>
imap <S-F3> <C-O>:call <SID>UnHighlightLine()<CR>
