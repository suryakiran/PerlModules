...
call <SID>AddAlternateExtensionMapping('hxx',"cxx,cpp,c")
call <SID>AddAlternateExtensionMapping('HXX',"CPP,C,CXX")
call <SID>AddAlternateExtensionMapping('HPP',"CPP,C")
call <SID>AddAlternateExtensionMapping('c',"h")
call <SID>AddAlternateExtensionMapping('C',"H")
call <SID>AddAlternateExtensionMapping('cpp',"h,hpp,hxx")
call <SID>AddAlternateExtensionMapping('CPP',"H,HPP,HXX")
call <SID>AddAlternateExtensionMapping('cc',"h,hpp")
...
call <SID>AddAlternateSearchPath("sfr:../include/cue")
