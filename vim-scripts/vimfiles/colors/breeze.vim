" Vim color file
"  Maintainer: Tiza
" Last Change: 07/18/2003 16:59:56 .
"     version: 1.0
...
" Split area
hi StatusLine   gui=BOLD guifg=#ff1111 guibg=#d0d0e0
...
" Diff
hi DiffText     gui=NONE guifg=#ffff55 guibg=#000000
hi DiffChange   gui=NONE guifg=#ffffff guibg=#000000
hi DiffDelete   gui=NONE guifg=#000000 guibg=#777777
hi DiffAdd      gui=NONE guifg=#cc1111 guibg=#ababab

" Cursor
hi Cursor       gui=NONE guifg=#ffffff guibg=#d86020
hi lCursor      gui=NONE guifg=#ffffff guibg=#e000b0
hi CursorIM     gui=NONE guifg=#ffffff guibg=#ffff00
