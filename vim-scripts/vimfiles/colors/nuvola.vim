...
hi cppStlIterators gui=BOLD guifg=#8233cb
hi cppStlFunctors  gui=BOLD guifg=#87b28f
hi cppStl          gui=BOLD guifg=#aa0033
hi cppMath         gui=NONE guifg=#f4ddb2
hi cppStreams      gui=BOLD guifg=#5555cc
hi cppFlags        gui=NONE guifg=#be00be
hi cppKeyword      gui=NONE guifg=#fe9e3f
hi cppCasts        gui=NONE guifg=#dd00dd

hi boostFunctions  gui=NONE   guifg=#aa00aa
hi boostClasses    gui=BOLD   guifg=#22aa22
